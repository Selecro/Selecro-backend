...
export const COOKIE_PARSER_OPTIONS = BindingKey.create<
  CookieParserOptions | undefined
...
export const CSRF_OPTIONS = BindingKey.create<
  CsrfMiddlewareOptions | undefined
>('csrf.options');
...
export const RATE_LIMIT_OPTIONS = BindingKey.create<
...
export namespace FirebaseBindings {
  export const ADMIN = BindingKey.create<typeof admin>(
    'services.firebase.admin',
  );
  export const OAUTH_STRATEGY = BindingKey.create<FirebaseOauthStrategy>(
    'authentication.strategies.firebase-oauth',
  );
  export const ADMIN_SERVICE = BindingKey.create<FirebaseAdminService>(
    'services.FirebaseAdminService',
  );
}

export namespace RemoteConfigBindings {
  export const CONFIG = BindingKey.create<RemoteConfigParameters>(
    'services.remoteConfig.config',
  );
  export const MAINTENANCE_MODE = BindingKey.create<boolean>(
    'services.remoteConfig.maintenanceMode',
  );
  export const MAINTENANCE_MESSAGE = BindingKey.create<string>(
    'services.remoteConfig.maintenanceMessage',
  );
  export const API_RATE_LIMIT_PER_SECOND = BindingKey.create<number>(
    'services.remoteConfig.apiRateLimitPerSecond',
  );
  export const API_REQUEST_WINDOW_MINUTES = BindingKey.create<number>(
    'services.remoteConfig.apiRequestWindowMinutes',
  );
  export const MAX_FILE_UPLOAD_SIZE_MB = BindingKey.create<number>(
    'services.remoteConfig.maxFileUploadSizeMb',
  );
  export const REDIS_CACHE_EXPIRY_SECONDS = BindingKey.create<number>(
    'services.remoteConfig.redisCacheExpirySeconds',
  );
}

...
export class User2FaLoginLog extends Entity {
  ...
  @property({
    ...
    jsonSchema: {nullable: false},
    generated: false,
    postgresql: {columnName: 'attempted_at', dataType: 'timestamp with time zone', dataLength: null, dataPrecision: null, dataScale: null, nullable: 'NO', generated: false},
  })
  attemptedAt: string;
  ...
  @property({
    ...
    length: 20,
    generated: false,
    postgresql: {columnName: 'method_used', dataType: 'character varying', dataLength: 20, dataPrecision: null, dataScale: null, nullable: 'NO', generated: false},
  })
  methodUsed: string;

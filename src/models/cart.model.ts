...
@model({settings: {idInjection: false, postgresql: {schema: 'public', table: 'cart'}}})
export class Cart extends Entity {
  ...
  @property({
    ...
    jsonSchema: {nullable: false},
    generated: false,
    postgresql: {columnName: 'cart_uuid', dataType: 'uuid', dataLength: null, dataPrecision: null, dataScale: null, nullable: 'NO', generated: false},
  })
  cartUuid: string;
